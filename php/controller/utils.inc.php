...
function fin_page()
{
    ?>
    <footer>
        <a class="cgu" href="http://bestsithever.alwaysdata.net/controller/mentionsController.php">Mentions légales</a>
        <a class="cgu" href="https://validator.w3.org/nu/?doc=http%3A%2F%2Fbestsithever.alwaysdata.net%2F">W3C Validator</a>
    </footer>
    <?php echo '</body>';
}
